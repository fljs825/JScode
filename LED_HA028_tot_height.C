void LED_HA028_tot_height()
{
	...
	TH1D *h1 = new TH1D("h1","HA028 5000 mV SPE height dist;height (ADC);The number of events", 300, -200, 200);
    TH1D *h2 = new TH1D("h2","HA028 5000 mV with TL SPE height dist;height (ADC);The number of events", 300, -200, 200);
    TH1D *h3 = new TH1D("h3","HA028 6000 mV SPE height dist;height ADC;The number of events", 300, -200, 200);
	TH1D *h4 = new TH1D("h4","HA028 6000 mV with TL SPE height dist;height ADC;The number of events", 300, -200, 200);
